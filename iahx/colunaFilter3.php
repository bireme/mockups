...
<div class="col-md-3 d-print-none" id="filterEsq">
	...
	<div>
		...
		<div class="box2 collapse show" id="bases">
			<div class="boxCheck">
				...
				<label class="labelCheck1" for="check6">Recursos Multimídia (426)</label></label>
			</div>
			<div class="boxCheck">
				<div class="inputCheck1"><input type="checkbox" id="check7"></div>
				<label class="labelCheck1" for="check7">LIS - Localizador de Informação em Saúde (346)</label></label>
			</div>
			<div class="boxCheck">
				<div class="inputCheck1"><input type="checkbox" id="check8"></div>
				<label class="labelCheck1" for="check8">SOF - Segunda opinião formativa (28)</label></label>
			</div>
			<div class="boxCheck">
				<div class="inputCheck1"><input type="checkbox" id="check9"></div>
				<label class="labelCheck1" for="check9">CVSP - Regional (4)</label></label>
			</div>
		</div>
	</div>
	...
	<div>
		<div class="titleBox2" data-toggle="collapse" data-target="#colecoes">
			Assunto Principal <span class="acordionIcone float-right fas fa-angle-up"></span>
		</div>
