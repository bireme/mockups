	...
	<div>
		...
		<div class="box2 collapse show" id="bases">
			<div class="boxCheck">
				...
				<label class="labelCheck1" for="check6">MEDILNE	(26390999)</label></label>
				<a href="#" class="icon-info"><i class="fa fa-info-circle icon-info"></i></a>
			</div>
			<div class="boxCheck">
				<div class="inputCheck1"><input type="checkbox" id="check7"></div>
				<label class="labelCheck1" for="check7">LILACS (849813)</label></label>
				<a href="#" class="icon-info"><i class="fa fa-info-circle icon-info"></i></a>
			</div>
			<div class="boxCheck">
				<div class="inputCheck1"><input type="checkbox" id="check8"></div>
				<label class="labelCheck1" for="check8">IBECS (171950)</label></label>
				<a href="#" class="icon-info"><i class="fa fa-info-circle icon-info"></i></a>
			</div>
			<div class="boxCheck">
				<div class="inputCheck1"><input type="checkbox" id="check9"></div>
				<label class="labelCheck1" for="check9">Randomized controlled trials (113114)</label></label>
				<a href="#" class="icon-info"><i class="fa fa-info-circle icon-info"></i></a>
			</div>
		</div>
	</div>
