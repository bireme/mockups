...
<head>
	...
	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/Js/raty-2.5.2/lib/jquery.min.js"></script>
  	<script type="text/javascript" src="<?php bloginfo('template_directory'); ?>/Js/raty-2.5.2/lib/jquery.raty.min.js"></script>
	<?php wp_head(); ?>
</head>
<body>		
	<header class="header">
