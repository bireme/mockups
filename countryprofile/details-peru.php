...
<body>
	...
	<main id="main_container" class="padding1">
		<div class="container">
			...
			<div class="row">
				<div class="col-1"><img src="img/peru-flag.jpg" class="img-fluid rounded" alt=""></div>
				<div class="col-11"><h1>Peru</h1></div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-lg-3 order-md-1">
					<div class="sticky-top">
						...
						<br><a href="peru.php" class="btn btn-warning btn-lg">More Information</a>
					</div>
				</div>
			</div>
		</div>
