    ...
    <div class="row g-3 align-items-stretch">
      ...
      <div class="col-lg-7">
        <a href="#" class="card overlay-card big text-white h-100">
          <img src="img/banner1.jpg" class="card-img" alt="Título">
      ...
      <div class="col-lg-5 d-flex flex-column gap-3">
        <a href="#" class="card overlay-card text-white flex-fill">
          <img src="img/banner2.jpg" class="card-img" alt="Título 1">
          <div class="card-img-overlay d-flex flex-column justify-content-end">
            <p class="eyebrow mb-1">Título</p>
            <h6 class="mb-0">
              Lorem ipsum dolor sit amet consectetur adipisicing, elit. Animi, ea sed porro temporibus hic.
        ...
        <a href="#" class="card overlay-card text-white flex-fill">
          <img src="img/banner3.jpg" class="card-img" alt="Título 2">
          <div class="card-img-overlay d-flex flex-column justify-content-end">
            <p class="eyebrow mb-1">Título</p>
            <h6 class="mb-0">
              Lorem ipsum dolor sit amet consectetur adipisicing, elit. Animi, ea sed porro temporibus hic.
