		...
		<div class="container">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Sobre o DeCS</li>
				</ol>
			</nav>
			...
			<p>
				Foi desenvolvido a partir do <i><a href="http://www.nlm.nih.gov/mesh/" target="_blank">MeSH - Medical Subject Headings</a></i> da <i>U.S.</i> <i>National</i> <i>Library of Medicine</i><i> (NLM)</i> com o objetivo de permitir o uso de terminologia comum para pesquisa em três idiomas, proporcionando um meio consistente e único para a recuperação da informação independentemente do idioma.
			</p>
			<p>
				O DeCS integra a <i><a href="http://metodologia.lilacs.bvsalud.org/php/index.php?lang=pt" target="_blank">metodologia LILACS</a></i> e é um componente integrador da BVS.
			</p>
			<p>
				Participa no projeto de desenvolvimento de terminologia única e rede semântica em saúde, <i><a href="http://www.nlm.nih.gov/research/umls/" target="_blank">UMLS - Unified Medical Language System</a></i> da <i>NLM</i> com a responsabilidade da atualização e envio dos termos em português e espanhol.
			</p>
			<p>
