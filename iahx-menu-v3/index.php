    ...
    <li class="nav-item" role="presentation">
        ...
        <a href="#" target="_blank" class="info-link">
    		<i class="fa-solid fa-circle-info"></i>
				...
				<li class="nav-item" role="presentation">
					<button class="nav-link" id="tab-2" data-toggle="tab" data-target="#all-lit" type="button" role="tab" aria-controls="all-lit" aria-selected="false"><b>Toda coleção da BVS</b>
						<br><small>54.661</small> </button>
				</li>
			</ul>
